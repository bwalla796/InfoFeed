...
export async function handlerUpsertTasks(req: Request, res: Response, next: NextFunction) {
    if(!req.params.id) {
...
export async function handlerDeleteTasks(req: Request, res: Response, next: NextFunction) {
    if(!req.params.id) {
